...
* 2026: Added escape sequences to string constants — JSON's simple ones (`\"`, `\\`, `\n`, `\t`, `\r`), which retires the workarounds demos used to reach for, such as writing a quote as `[34]` or substituting one character for another after the fact.
